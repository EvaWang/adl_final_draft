...
class BertQA(pl.LightningModule):
    ...
    def _calculate_val_loss(self, start_hat, end_hat, start, end, token_type_ids, attention_mask):
        # 答案應該在[0, max_len]之間 cross entropy class超過(480-1)噴nan/inf
    ...
    def training_step(self, batch, batch_nb):
        ...
        has_tag_logit, logit_tag = self.forward(input_ids, token_type_ids, attention_mask, pos_tag)
        ...
        # loss_val = self._calculate_val_loss(logit_start, logit_end, batch["value_start"], batch["value_end"], token_type_ids, attention_mask)
    ...
    def validation_step(self, batch, batch_nb):
        ...
        # loss_val = self._calculate_val_loss(logit_val, value)
